...
export function AboutSection() {
  return (
    <section id="about" className="bg-surface-container-lowest py-24 sm:py-28">
      <Container className="grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
        ...
        <div className="space-y-8 lg:pb-10">
          <blockquote className="text-2xl font-light italic leading-relaxed tracking-[-0.03em] text-on-surface-variant">
            “We do not just sell software. We design operating leverage. The output should feel structurally
            transformative, not cosmetically innovative.”
          </blockquote>

          <div className="space-y-4">
            {focusAreas.map((area) => (
              <div key={area} className="rounded-full bg-surface-container-high px-5 py-4 text-sm text-on-surface-variant">
                {area}
              </div>
            ))}
          </div>
